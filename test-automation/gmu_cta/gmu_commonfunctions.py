...
class commonfunctions:
    ...
    def happyflow(self):
        ...
        # OTP Connection
        conn = mysql.connector.connect(host=gmu_host_live, database=gmu_databasename_live, user=gmu_username_live, password=gmu_pass_live)
        ...
        return random_names, random_emails, randomnumber, Stream_value, State_value, City_value, Submit_Text
