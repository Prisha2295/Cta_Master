...
class Test_Insurancedetail(commonfunctions):
        
    
    baseUrl = ReadConfig.InsurancedetailURL()

    def test_insurancedetailcta(self, setup):
        self.logger = Logs.loggen('Test InsuranceDetail')  # logger of current test case
        self.logger.info("******* Starting CTA TEST INSURANCEDETAIL**********")
        ...
        avail_insurance = self.driver.find_element(By.XPATH,"//button[@id='btn-cta-39']")
        time.sleep(2)
        avail_insurance_text = avail_insurance.text
        self.logger.info( "CTA Text : " + avail_insurance_text)
        time.sleep(2)
        avail_insurance.click()
        time.sleep(2)
        # self.name_negative()
        # time.sleep(2)
        # self.name_positive()
        ...
        data = {
                'CTA' : [ avail_insurance_text , avail_insurance_text , avail_insurance_text, avail_insurance_text, avail_insurance_text, avail_insurance_text],
        ...
        df.to_csv('insurancedetail.csv', mode='a', header=False, index=False)
